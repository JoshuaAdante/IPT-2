          ...
          <div className="admin-left-section">
            <div className="admin-logo-icon">
              <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M100 100V120" stroke="#3B82F6" strokeWidth="4"/>
                <path d="M70 90V110C70 115 82 125 100 125C118 125 130 115 130 110V90" stroke="#3B82F6" strokeWidth="4" fill="none"/>
                {/* Left Hand */}
                <path d="M40 100C40 100 35 105 32 110C30 113 28 118 30 122C32 126 36 128 40 128C42 128 44 127 46 125L55 115" fill="#60A5FA" stroke="#3B82F6" strokeWidth="2"/>
                {/* Right Hand */}
                <path d="M160 100C160 100 165 105 168 110C170 113 172 118 170 122C168 126 164 128 160 128C158 128 156 127 154 125L145 115" fill="#60A5FA" stroke="#3B82F6" strokeWidth="2"/>
                {/* Hands supporting from below */}
                <ellipse cx="40" cy="130" rx="15" ry="8" fill="#60A5FA"/>
